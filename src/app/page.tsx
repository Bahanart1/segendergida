...
export default function Home() {
  return (
    <main className="min-h-screen bg-white flex items-center justify-center text-center">
      <div>
        <h1 className="text-4xl font-bold text-gray-800">Geçici olarak kapalıdır</h1>
        <p className="text-lg text-gray-600 mt-4">Bakım çalışması nedeniyle site şu anda erişime kapalıdır.</p>
      </div>
    </main>
  );
// //   return (
